...
$(function() {
    ...
    h5.whenAddPage = function() {
        this.addComponent('slide_up', {
            bg: config.idx + '/imgs/footer_bg.png',
            css: {
                opacity: 0,
                left: 0,
                bottom: -20,
    ...
    h5
        ...
        .addComponent('join', {
            ...
            width: 280,
            height: 27,
            bg: config.idx + '/imgs/face_join.png',
        ...
        .addComponent('people', {
            ...
            width: 514,
            height: 304,
            bg: config.idx + '/imgs/p-people.png',
            css: { bottom: 0, opacity: 0 },
            animateIn: { bottom: 60, opacity: 1 },
            animateOut: { bottom: 0, opacity: 0 },
            delay: 1000
        ...
        .addComponent('women', {
            width: 213,
            height: 311,
            bg: config.idx + '/imgs/p-women.png',
        ...
        .addComponent('phone', {
            ...
            // height: 600,
            data: [
                config.idx + '/imgs/people/p-1.png',
                config.idx + '/imgs/people/p-2.png',
                config.idx + '/imgs/people/p-3.png',
                config.idx + '/imgs/people/p-4.png',
                config.idx + '/imgs/people/p-5.png',
                config.idx + '/imgs/people/p-6.png',
                config.idx + '/imgs/people/p-7.png',
                config.idx + '/imgs/people/p-8.png',
                config.idx + '/imgs/people/p-9.png',
                config.idx + '/imgs/people/p-10.png',
                config.idx + '/imgs/people/p-11.png',
                config.idx + '/imgs/people/p-12.png',
                config.idx + '/imgs/people/p-13.png',
                config.idx + '/imgs/people/p-14.png',
                config.idx + '/imgs/people/p-15.png',
                config.idx + '/imgs/people/p-16.png',
                config.idx + '/imgs/people/p-17.png',
                config.idx + '/imgs/people/p-18.png',
                config.idx + '/imgs/people/p-19.png',
                config.idx + '/imgs/people/p-20.png',
                config.idx + '/imgs/people/p-21.png',
                config.idx + '/imgs/people/p-22.png',
                config.idx + '/imgs/people/p-23.png',
                config.idx + '/imgs/people/p-24.png',
                config.idx + '/imgs/people/p-25.png',
                config.idx + '/imgs/people/p-26.png',
                config.idx + '/imgs/people/p-27.png',
                config.idx + '/imgs/people/p-28.png',
                config.idx + '/imgs/people/p-29.png',
                config.idx + '/imgs/people/p-30.png',
                config.idx + '/imgs/people/p-31.png',
                config.idx + '/imgs/people/p-32.png',
                config.idx + '/imgs/people/p-33.png',
                config.idx + '/imgs/people/p-34.png',
                config.idx + '/imgs/people/p-35.png',
                config.idx + '/imgs/people/p-36.png',
                config.idx + '/imgs/people/p-37.png',
                config.idx + '/imgs/people/p-38.png',
                config.idx + '/imgs/people/p-39.png',
                config.idx + '/imgs/people/p-40.png',
                config.idx + '/imgs/people/p-41.png',
                config.idx + '/imgs/people/p-42.png',
                config.idx + '/imgs/people/p-43.png',
                config.idx + '/imgs/people/p-44.png',
                config.idx + '/imgs/people/p-45.png',
                config.idx + '/imgs/people/p-46.png',
                config.idx + '/imgs/people/p-47.png',
                config.idx + '/imgs/people/p-48.png',
                config.idx + '/imgs/people/p-49.png',
                config.idx + '/imgs/people/p-50.png',
                config.idx + '/imgs/people/p-51.png',
                config.idx + '/imgs/people/p-52.png',
                config.idx + '/imgs/people/p-53.png',
                config.idx + '/imgs/people/p-54.png',
                config.idx + '/imgs/people/p-55.png',
                config.idx + '/imgs/people/p-56.png',
        ...
        .loader([
            config.idx + '/imgs/page_bg.png',
            config.idx + '/imgs/face_bg.png',
            config.idx + '/imgs/page_caption_bg.png',
            config.idx + '/imgs/footer_bg.png',
            config.idx + '/imgs/face_hi.png',
            config.idx + '/imgs/face_slogan.png',
            config.idx + '/imgs/face_join.png',
            config.idx + '/imgs/p-people.png',
            config.idx + '/imgs/p-men.png',
            config.idx + '/imgs/p-pk.png',
            config.idx + '/imgs/p-women.png',
            config.idx + '/imgs/p-team1.png',
            config.idx + '/imgs/p-team2.png',
            config.idx + '/imgs/p-team3.png',
            config.idx + '/imgs/p-team4.png',
            config.idx + '/imgs/people/p-1.png',
            config.idx + '/imgs/people/p-2.png',
            config.idx + '/imgs/people/p-3.png',
            config.idx + '/imgs/people/p-4.png',
